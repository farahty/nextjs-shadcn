const PrivacyPag = () => {
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Farahty Todo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Palestinian Territories
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Farahty Todo, accessible from{" "}
            <a
              href="https://farahty.com/"
      ...
      <ul>
        <li>By email: nimer@farahty.com</li>
      </ul>
    </div>
  );
};

export default PrivacyPag;
