const TermsPage = () => {
  return (
    <div className="prose dark:prose-invert w-full max-w-none">
      ...
      <p>Welcome to Farahty Todo App!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Farahty Company&apos;s Website, located at https://farahty.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Farahty Todo App if you do not agree
      ...
      <p>
        ...
        prevailing law of ps. Any use of the above terminology or other words in
      ...
      <p>
        We employ the use of cookies. By accessing Farahty Todo App, you agreed
        to use cookies in agreement with the Farahty Company&apos;s Privacy
        Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Farahty Company and/or its licensors own the
        intellectual property rights for all material on Farahty Todo App. All
        intellectual property rights are reserved. You may access this from
        Farahty Todo App for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Farahty Todo App</li>
        <li>Sell, rent or sub-license material from Farahty Todo App</li>
        <li>Reproduce, duplicate or copy material from Farahty Todo App</li>
        <li>Redistribute content from Farahty Todo App</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Farahty Company does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Farahty Company,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Farahty Company
      ...
      <p>
        Farahty Company reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Farahty Company a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Farahty Company; and (d) the
      ...
      <p>
        ...
        e-mail to Farahty Company. Please include your name, your organization
      ...
      <p>
        No use of Farahty Company&apos;s logo or other artwork will be allowed
